...
config.max_reclaim_per_poll = 32    # Bound reclamation work

# Architecture selection
config.queue_impl = 'auto'          # 'auto', 'scq', 'lcrq'

# Debugging
config.enable_statistics = True     # Track operation counts
```
...
| Platform | CI Testing |
|----------|------------|
| Linux x86-64 | Primary (GitHub Actions) |
| Linux ARM64 | Required (tests LCRQ fallback) |
| macOS x86-64 | Required |
| macOS ARM64 | Required |
| Windows x86-64 | Best effort |
...
### 9.1 Potential Additions (Post-1.0)
